...
public class TabGraphe extends JTabbedPane {
	...
	private static String[] EXPLICATIONS = {"<html><body style='background-color:rgb(90,90,90); font-family:Calibri; font-weight:light; color:white; margin-top:30px; font-size:140%;'>Remplissez les 4 cases de pourcentages pour maintenant, <br> pour après, et pour encore après. <br> <br> Pour que le schéma soit valide, le total des 4 pourcentages <br> doit atteindre 100%.</body></html>",
			...
			"<html><body style='background-color:rgb(90,90,90); font-family:Calibri; font-weight:light; color:white; margin-top:30px; font-size:130%;'>Choisissez une entreprise principale en cliquant dessus <br>puis notez les autres structures <br> sur 10 en suivant la démarche suivante : <br> <br> - Cliquer sur la structure à noter <br> - Entrer la note sur 10 <br> - Appuyer sur ENTREE pour valider </body></html>"
	};
		...
		case 6:
			try{
				if(FenetreAccueil.etude.getS6().getMtn().getNumero()==1){
					...
					if(FenetreAccueil.etude.getS6().getMtn_notee()[0].getNote()!=Integer.MAX_VALUE){
						this.getConteneur_maintenant().setNote_entrep_duale(FenetreAccueil.etude.getS6().getMtn_notee()[0].getNote());
					}
					if(FenetreAccueil.etude.getS6().getMtn_notee()[1].getNote()!=Integer.MAX_VALUE){
						this.getConteneur_maintenant().setNote_entrep_modernisee(FenetreAccueil.etude.getS6().getMtn_notee()[1].getNote());
					}
					if(FenetreAccueil.etude.getS6().getMtn_notee()[2].getNote()!=Integer.MAX_VALUE){
						this.getConteneur_maintenant().setNote_entrep_crise(FenetreAccueil.etude.getS6().getMtn_notee()[2].getNote());
					}
					if(FenetreAccueil.etude.getS6().getMtn_notee()[3].getNote()!=Integer.MAX_VALUE){
						this.getConteneur_maintenant().setNote_entrep_bureaucratique(FenetreAccueil.etude.getS6().getMtn_notee()[3].getNote());
					}
				}
					...
					if(FenetreAccueil.etude.getS6().getMtn_notee()[0].getNote()!=Integer.MAX_VALUE){
						this.getConteneur_maintenant().setNote_entrep_communaute(FenetreAccueil.etude.getS6().getMtn_notee()[0].getNote());
					}
					if(FenetreAccueil.etude.getS6().getMtn_notee()[1].getNote()!=Integer.MAX_VALUE){
						this.getConteneur_maintenant().setNote_entrep_modernisee(FenetreAccueil.etude.getS6().getMtn_notee()[1].getNote());
					}
					...
					if(FenetreAccueil.etude.getS6().getMtn_notee()[1].getNote()!=Integer.MAX_VALUE){
						this.getConteneur_maintenant().setNote_entrep_duale(FenetreAccueil.etude.getS6().getMtn_notee()[1].getNote());
					}
					if(FenetreAccueil.etude.getS6().getMtn_notee()[2].getNote()!=Integer.MAX_VALUE){
						this.getConteneur_maintenant().setNote_entrep_crise(FenetreAccueil.etude.getS6().getMtn_notee()[2].getNote());
					}
					...
					if(FenetreAccueil.etude.getS6().getMtn_notee()[2].getNote()!=Integer.MAX_VALUE){
						this.getConteneur_maintenant().setNote_entrep_modernisee(FenetreAccueil.etude.getS6().getMtn_notee()[2].getNote());
					}
					if(FenetreAccueil.etude.getS6().getMtn_notee()[3].getNote()!=Integer.MAX_VALUE){
						this.getConteneur_maintenant().setNote_entrep_bureaucratique(FenetreAccueil.etude.getS6().getMtn_notee()[3].getNote());
					}
					...
					if(FenetreAccueil.etude.getS6().getMtn_notee()[3].getNote()!=Integer.MAX_VALUE){
						this.getConteneur_maintenant().setNote_entrep_crise(FenetreAccueil.etude.getS6().getMtn_notee()[3].getNote());
					}
				}
			}catch(NullPointerException ex){}
			try{
				if(FenetreAccueil.etude.getS6().getApr().getNumero()==1){
					...
					if(FenetreAccueil.etude.getS6().getApr_notee()[0].getNote()!=Integer.MAX_VALUE){
						this.getConteneur_apres().setNote_entrep_duale(FenetreAccueil.etude.getS6().getApr_notee()[0].getNote());
					}
					if(FenetreAccueil.etude.getS6().getApr_notee()[1].getNote()!=Integer.MAX_VALUE){
						this.getConteneur_apres().setNote_entrep_modernisee(FenetreAccueil.etude.getS6().getApr_notee()[1].getNote());
					}
					if(FenetreAccueil.etude.getS6().getApr_notee()[2].getNote()!=Integer.MAX_VALUE){
						this.getConteneur_apres().setNote_entrep_crise(FenetreAccueil.etude.getS6().getApr_notee()[2].getNote());
					}
					if(FenetreAccueil.etude.getS6().getApr_notee()[3].getNote()!=Integer.MAX_VALUE){
						this.getConteneur_apres().setNote_entrep_bureaucratique(FenetreAccueil.etude.getS6().getApr_notee()[3].getNote());
					}
				}
					...
					if(FenetreAccueil.etude.getS6().getApr_notee()[0].getNote()!=Integer.MAX_VALUE){
						this.getConteneur_apres().setNote_entrep_communaute(FenetreAccueil.etude.getS6().getApr_notee()[0].getNote());
					}
					if(FenetreAccueil.etude.getS6().getApr_notee()[1].getNote()!=Integer.MAX_VALUE){
						this.getConteneur_apres().setNote_entrep_modernisee(FenetreAccueil.etude.getS6().getApr_notee()[1].getNote());
					}
					...
					if(FenetreAccueil.etude.getS6().getApr_notee()[1].getNote()!=Integer.MAX_VALUE){
						this.getConteneur_apres().setNote_entrep_duale(FenetreAccueil.etude.getS6().getApr_notee()[1].getNote());
					}
					if(FenetreAccueil.etude.getS6().getApr_notee()[2].getNote()!=Integer.MAX_VALUE){
						this.getConteneur_apres().setNote_entrep_crise(FenetreAccueil.etude.getS6().getApr_notee()[2].getNote());
					}
					...
					if(FenetreAccueil.etude.getS6().getApr_notee()[2].getNote()!=Integer.MAX_VALUE){
						this.getConteneur_apres().setNote_entrep_modernisee(FenetreAccueil.etude.getS6().getApr_notee()[2].getNote());
					}
					if(FenetreAccueil.etude.getS6().getApr_notee()[3].getNote()!=Integer.MAX_VALUE){
						this.getConteneur_apres().setNote_entrep_bureaucratique(FenetreAccueil.etude.getS6().getApr_notee()[3].getNote());
					}
					...
					if(FenetreAccueil.etude.getS6().getApr_notee()[3].getNote()!=Integer.MAX_VALUE){
						this.getConteneur_apres().setNote_entrep_crise(FenetreAccueil.etude.getS6().getApr_notee()[3].getNote());
					}
				}
			}catch(NullPointerException ex){}
			...
			try{
				if(FenetreAccueil.etude.getS6().getRis().getNumero()==1){
					...
					if(FenetreAccueil.etude.getS6().getRis_notee()[0].getNote()!=Integer.MAX_VALUE){
						cont_6.setNote_entrep_duale(FenetreAccueil.etude.getS6().getRis_notee()[0].getNote());
					}
					if(FenetreAccueil.etude.getS6().getRis_notee()[1].getNote()!=Integer.MAX_VALUE){
						cont_6.setNote_entrep_modernisee(FenetreAccueil.etude.getS6().getRis_notee()[1].getNote());
					}
					if(FenetreAccueil.etude.getS6().getRis_notee()[2].getNote()!=Integer.MAX_VALUE){
						cont_6.setNote_entrep_crise(FenetreAccueil.etude.getS6().getRis_notee()[2].getNote());
					}
					if(FenetreAccueil.etude.getS6().getApr_notee()[3].getNote()!=Integer.MAX_VALUE){
						cont_6.setNote_entrep_bureaucratique(FenetreAccueil.etude.getS6().getRis_notee()[3].getNote());
					}
				}
					...
					if(FenetreAccueil.etude.getS6().getRis_notee()[0].getNote()!=Integer.MAX_VALUE){
						cont_6.setNote_entrep_communaute(FenetreAccueil.etude.getS6().getRis_notee()[0].getNote());
					}
					if(FenetreAccueil.etude.getS6().getRis_notee()[1].getNote()!=Integer.MAX_VALUE){
						cont_6.setNote_entrep_modernisee(FenetreAccueil.etude.getS6().getRis_notee()[1].getNote());
					}
					...
					if(FenetreAccueil.etude.getS6().getRis_notee()[1].getNote()!=Integer.MAX_VALUE){
						cont_6.setNote_entrep_duale(FenetreAccueil.etude.getS6().getRis_notee()[1].getNote());
					}
					if(FenetreAccueil.etude.getS6().getRis_notee()[2].getNote()!=Integer.MAX_VALUE){
						cont_6.setNote_entrep_crise(FenetreAccueil.etude.getS6().getRis_notee()[2].getNote());
					}
					...
					if(FenetreAccueil.etude.getS6().getRis_notee()[2].getNote()!=Integer.MAX_VALUE){
						cont_6.setNote_entrep_modernisee(FenetreAccueil.etude.getS6().getRis_notee()[2].getNote());
					}
					if(FenetreAccueil.etude.getS6().getApr_notee()[3].getNote()!=Integer.MAX_VALUE){
						cont_6.setNote_entrep_bureaucratique(FenetreAccueil.etude.getS6().getRis_notee()[3].getNote());
					}
					...
					if(FenetreAccueil.etude.getS6().getApr_notee()[3].getNote()!=Integer.MAX_VALUE){
						cont_6.setNote_entrep_crise(FenetreAccueil.etude.getS6().getRis_notee()[3].getNote());
					}
				}
			}catch(NullPointerException ex){}
			break;
